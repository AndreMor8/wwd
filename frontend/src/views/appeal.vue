<template>
  <div v-if="banned && loaded && !appealed">
    <h1 class="title wwd_main_title">Appeal your ban</h1>
  ...
  <h1 v-else-if="!logged" class="title wwd_main_title">
    You must be logged before using this route!
  </h1>
  <h1 v-else-if="appealed" class="title wwd_main_title">
    You already made your appeal!
  </h1>
  <h1 v-else-if="!loaded" class="title wwd_main_title">Loading...</h1>
  <h1 v-else class="title wwd_main_title">You are not banned!</h1>
</template>
